...
//         // async authorize(credentials) {
//         try {
//           logger.info('Requesting log in, redirecting...');
//           logger.info('URL for login: ' + process.env.NEXT_PUBLIC_BACKEND_URL);
...
//             },
//           });
//           logger.info('NextAuth login finished');

//           // console.log('Respuesta Server', res);
//           const user = await reslogin.json();

//           logger.info('Reading back token');

//           const backToken = user?.token;

//           logger.info('Setting back token to cookies');
